// utils/teaSetHourTest.js - TEST VERSION
// This version forces Tea Set Hour to always be active for testing
...
export const isTeaSetHourActive = () => {
  // FOR TESTING - Force Tea Set Hour to always be active
  return true;
};
